...
// Lazy load renderers — both are heavy and only needed at runtime
...
const TYPE_COLORS: Record<string, string> = {
  ...
  explainer: "text-violet-400 bg-violet-400/10 border-violet-400/20",
};
        ...
        <div className="flex-shrink-0 border-b border-rim px-4 sm:px-6 py-3">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-text-muted text-2xs mt-0.5">
                Charts, explainers, tables, and files generated by DAWN
              </p>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              {["all", "chart", "explainer", "table", "image", "file"].map((t) => (
                <button
                  key={t}
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full gap-2">
              ...
              <p className="text-text-muted text-sm">
                {artifacts.length === 0
                  ? "No artifacts yet. Ask DAWN to visualize or explain something!"
      ...
      {selectedArtifact && (
        <div className="w-96 border-l border-rim bg-surface/80 backdrop-blur-sm overflow-y-auto flex-shrink-0 hidden lg:block">
          <div className="p-4">
            ...
            {/* Render explainer if it has code */}
            {selectedArtifact.type === "explainer" && selectedArtifact.code && (
              <div className="mb-4">
                <Suspense
                  fallback={
                    <div className="flex items-center justify-center py-8 rounded-xl border border-rim bg-surface/50">
                ...
                >
                  <ExplainerRenderer code={selectedArtifact.code} title={selectedArtifact.title} />
                </Suspense>
              </div>
            )}
            ...
            <div className="text-text-muted text-2xs space-y-1">
              ...
              {selectedArtifact.metadata && (
                <div className="mt-2">
                  <h4 className="text-text-muted text-2xs font-medium uppercase tracking-wider mb-1">Metadata</h4>
                  <pre className="text-2xs font-mono text-text-muted whitespace-pre-wrap">
